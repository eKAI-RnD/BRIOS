...
import math
from models import rios_with_attention
...
class Model(nn.Module):
    ...
    def build(self):
        self.rios_f = rios_with_attention.Model(self.rnn_hid_size, self.INPUT_SIZE, self.SEQ_LEN, self.SELECT_SIZE)
        self.rios_b = rios_with_attention.Model(self.rnn_hid_size, self.INPUT_SIZE, self.SEQ_LEN, self.SELECT_SIZE)

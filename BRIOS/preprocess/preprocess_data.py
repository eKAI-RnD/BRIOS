...
def create_json_data(dir):
    ...
    """
    region = 'data2/'
    ndvi_raster_path = dir + region + 'ndvi_8days'
    sar_raster_path = dir + region + 'rvi_8days'
    ...
    fs = open(dir + region + 'dataTrain/training_data.json', 'w')
...
# create_json_data(dir='/mnt/data1tb/brios/BRIOS/datasets/')